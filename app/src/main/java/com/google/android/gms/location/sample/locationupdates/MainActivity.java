    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.showonmap)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:<" + mCurrentLocation.getLatitude()  + ">,<" + mCurrentLocation.getLongitude() + ">?q=<" + mCurrentLocation.getLatitude()  + ">,<" + mCurrentLocation.getLongitude() + ">(" + "my loc" + ")"));
